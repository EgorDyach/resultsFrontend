...
export default function AddForm({setIsAddForms}) {
    return (
        <div className={"modalForm"}>
            <h2 class={"modalFormTitle"}>Добавление участника</h2>
            <div className={"addFormWrapper"}>
                ...
                <button className={"addFormBtn"} onClick={() => setIsAddForms()}>
                ...
                <button className={"actionBtn"} onClick={() => {
                    ...
                    serverAddParticipant(participant)
                    setIsAddForms()
                }}>Сохранить
                </button>
            </div>
